    ...
    return (
        <div className={HomeCss.parentOf_img_textCard}>
            ...
            <div className={HomeCss.cardTextParent}>
                ...
                <h6 className={HomeCss.card_title}>Golfhōm Gear Review – The Circle 15 Genesis Golf Glove...</h6>
                ...
                <div className={HomeCss.bookmarkDiv}>
                    <Image
                        ...
                        height={15}
                    ></Image>{" "}
                    <span className={HomeCss.bookmark_text}>Golf, Golf Travel, Vacation Rentals</span>
                </div>
