...
const ContactUs = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact Golfhom: Get in Touch with Our Team | Golfhom</title>
        <meta
          name="description"
          content="Have questions or comments about Golfhom? Reach out to our staff via the contact form. We are here to assist you and will respond as soon as possible."
        />
