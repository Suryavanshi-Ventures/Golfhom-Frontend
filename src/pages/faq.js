...
const FAQ = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Golfhom FAQ's: Answers to Your Booking Questions | Golfhom
        </title>
        <meta
          name="description"
          content="Get answers to frequently asked questions about booking, property amenities, cancellations, and more at Golfhom. Our team is here to help you make the most of your golf vacation experience."
        />
