        ...
        <>
            <Container className={Checkout2Css.grand}>
                <Row className={Checkout2Css.parentRow}>
                    ...
                    <h2 className={Checkout2Css.payment_unsuccessful}>Payment Unsuccessful</h2>

                    <h5 className={Checkout2Css.payment_discription}>Your payment has been Unsuccessful
                        <br />
                        hence it has not send to the receiver bank</h5>
                </Row>
            </Container>
        </>
    )
