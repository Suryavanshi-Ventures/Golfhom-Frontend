...
const TermAndConditions = () => {
  return (
    <>
      <Head>
        <title>
          Golfhom Terms and Conditions: Understanding Our Policies | Golfhom
        </title>
        <meta
          name="description"
          content="Read Golfhom's Terms and Conditions to understand the policies that govern your use of our website. Learn about the roles and responsibilities when booking vacation rentals, and our commitment to user privacy."
        />
      ...
      <Container>
        ...
        <p className={TermConditionsCss.para}>
          Golfhom.com (“Website”) is provided solely to assist customers in
